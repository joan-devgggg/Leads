...
_CITY_CLASS_ALIASES = {
    "mega_city": {"dubai", "london", "new york", "new york city", "nyc", "paris", "berlin", "istanbul", "madrid", "barcelona"},
    "large_city": {"valencia", "milan", "lisbon", "buenos aires", "rome", "seville", "sevilla", "bilbao", "lyon", "bogota", "bogotá", "santiago", "lima"},
    "medium_city": set(),
    "small_city": set(),
}
